function valdata = mergeEnergyBased_validation(pB, pC, edgeind, bndinfo, offBias)
%
% valdata = mergeEnergyBased_validation(pB, pC, edgeind, bndinfo, offBias)
%  
%
...
nsp = max(wseg(:));
segError(currv) = getSegmentationErrorFast(bndinfo.labels, nsp, rsp(validr), areas);
