...
%bndx是来自于useClassifier函数的输出特征，有60维
% getContinuityFeatures返回的特征是当前边的所有临边的特征矩阵，维度是nc2*126维，
% 放到整张图片中去就是：所有边的临近边的ids数目累加和*126维
